...
const adm1Path = path.join(__dirname, "public", "data", "geoBoundaries-JAM-ADM1.geojson");
const adm3Path = path.join(__dirname, "public", "data", "geoBoundaries-JAM-ADM3.geojson");
const outputPath = path.join(__dirname, "public", "data", "geoBoundaries-JAM-ADM3-tagged.geojson");
